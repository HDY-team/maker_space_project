								...
								<tr>
									...
									<c:if test="${dto.process==1}">
										<form method="post" action="processcontroller">
											...
											<input type="hidden" name="action" value="mySelectedComplete">
											<input type="hidden" name="category" value="mySelect">
											<input type="submit"
												class="btn btn-block-lg btn-lg btn-primary"
												style="display: inline-block;" value="승인하기" />
										</form>
										<form method="post" action="processcontroller">
											<input type="hidden" name="businessBoardsIdx"
												value=<c:out value="${dto.businessIdx}"/>>
											<input type="hidden" name="action" value="mySelectCancel">
											<input type="hidden" name="category" value="mySelect">
											<input type="submit"
												class="btn btn-block-lg btn-lg btn-primary"
