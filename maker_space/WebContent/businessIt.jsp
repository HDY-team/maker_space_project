						...
						<ul class="pagination">
							...
							<c:if test="${map.prevPage > 0}">
								<li class="page-item"><a class="page-link"
									href="boardcontroller?action=getBoard&page=${map.prevPage}&category=it&field=${map.field }">&laquo;</a>
								</li>
							</c:if>
							<c:if test="${map.pageCount <= 5}">
								<c:forEach begin="${map.beginPage}"
									...
									<c:choose>
										...
										<c:otherwise>
											<li class="page-item"><a class="page-link"
												href="boardcontroller?action=getBoard&page=${page}&field=${map.field}&category=it">${page}</a></li>
										</c:otherwise>
									</c:choose>
								</c:forEach>
							</c:if>
							...
							<c:if test="${map.nextPage > 0}">
								<li class="page-item"><a class="page-link"
									href="boardcontroller?action=getBoard&page=${map.nextPage}&field=${map.field }&category=it">&raquo;</a>
								</li>
							</c:if>
						</ul>
					</div>
