...
<html lang="en">
  ...
  <head>
    ...
    <link href="./Resource/mms/vendor/simple-line-icons/css/simple-line-icons.css" rel="stylesheet" type="text/css">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary" id="">
      ...
      <div class="collapse navbar-collapse" id="navbarColor01">
        ...
        <form class="form-inline my-2 my-lg-0">
            <button type="button" class="btn btn-secondary my-2 my-sm-0" onclick="location.href='login.jsp'">Sign in</button>
        </form>
      </div>
    </nav>
            ...
            <form>
              <div class="form-row">
                <div class="col-12 col-md-9 mb-2 mb-md-0">
                  <input type="text" class="form-control form-control-lg" placeholder="# 5G # 1µî KT ... ">
                </div>
