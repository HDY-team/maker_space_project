          ...
          <div class="form-group">
            <div class="form-row">
              ...
              <div class="col-md-4">
                ...
                <button type="button" class="btn btn-primary btn-sm">이메일인증</button>
              </div>
            </div>
          </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-8">
                <label for="exampleInputEmail1">Email 인증</label>
                <input class="form-control" id="exampleInputEmail1" type="email" aria-describedby="emailHelp" placeholder="Enter email 인증 문자">
              </div>
              <div class="col-md-4">
                <label for="exampleInputEmail1">&nbsp;</label><br>
                <button type="button" class="btn btn-primary btn-sm">인증확인</button>
              </div>
            </div>
          </div>
          <div class="form-group">
